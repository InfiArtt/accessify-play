...
addon_info = AddonInfo(
	...
	addon_changelog=_("""
- **Hotfix (1.9.1)**: Fixed a critical UI bug where the NVDA settings dialog would crash and bleed into other add-on panels, preventing users from validating their credentials.
